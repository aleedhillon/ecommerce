            ...
            <template #form="{ submitted, handlePhotoUpload, photoPreview, resolveImagePath }">
                <div class="formgrid grid">
                    ...
                    <div class="col-12 mb-3 mt-3">
                        <h3 class="text-xl font-semibold">Pricing & Inventory</h3>
                    </div>
                    ...
                    <!-- Categories Section -->
                    <div class="col-12 mb-3 mt-3">
                        <h3 class="text-xl font-semibold">Categories & Attributes</h3>
                    </div>
                    ...
                    <div class="col-12 mb-3 mt-3">
                        <h3 class="text-xl font-semibold">Physical Properties</h3>
                    </div>
                    ...
                    <div class="col-12 mb-3 mt-3">
                        <h3 class="text-xl font-semibold">Product Image</h3>
                    </div>
                    ...
                    <!-- Description Section -->
                    <div class="col-12 mb-3 mt-3">
                        <h3 class="text-xl font-semibold">Description & Details</h3>
                    </div>
                    ...
                    <!-- SEO Section -->
                    <div class="col-12 mb-3 mt-3">
                        <h3 class="text-xl font-semibold">SEO Information</h3>
                    </div>
